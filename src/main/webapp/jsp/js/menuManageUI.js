...
var vm = new Vue({
    ...
    methods: {
        getMenu: function(menuId){
            //加载菜单树
            $.get(baseURL + "sys/menu/select.do", function(r){
...
//            $.get(baseURL + "sys/menu/info.do/"+menuId, function(r){
//                vm.showList = false;
//                vm.title = "修改";
//                vm.menu = r.menu;
//
...
//            });
        ...
        del: function () {
            ...
            confirm('确定要删除选中的记录？', function(){
                $.ajax({
                    type: "POST",
                    url: baseURL + "sys/menu/delete.do",
                    data: "menuId=" + menuId,
                    success: function(r){
                        if(r.code === 0){
                            alert('操作成功');
        ...
        saveOrUpdate: function (event) {
            var url = vm.menu.menuId == null ? "sys/menu/save.do" : "sys/menu/update.do";
            $.ajax({
                type: "POST",
                url: baseURL + url,
...
$(function () {
    ...
    var table = new TreeTable(Menu.id, baseURL + "/sys/menu/list.do", colunms);
