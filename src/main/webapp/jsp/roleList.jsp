...
<body>
		...
		<div v-show="showList">
			<div class="grid-btn">
				...
				<a class="btn btn-default" @click="query">查询</a> <a
					v-if="hasPermission('sys:role:save')" class="btn btn-primary"
					@click="add"><i class="fa fa-plus"></i>&nbsp;新增</a> <a
					v-if="hasPermission('sys:role:update')" class="btn btn-primary"
					@click="update"><i class="fa fa-pencil-square-o"></i>&nbsp;修改</a> <a
					v-if="hasPermission('sys:role:delete')" class="btn btn-primary"
	...
	<script src="js/roleListUI.js"></script>
</body>
</html>