...
<div class="wrapper" id="rrapp" v-cloak>
  <header class="main-header">
    <a href="index.jsp" class="logo">
      ...
      <span class="logo-mini"><b>招生信息管理</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>招生信息管理</b></span>
    </a>
...
<!--           <li><a href="javascript:;" @click="donate"><i class="fa fa-jpy"></i> &nbsp;</a></li> -->
<!--           <li><a href="" target="_blank"><i class="fa fa-home"></i> &nbsp;编程教程</a></li> -->
		  <li><a href="javascript:;" @click="personalInfo"><i class="fa fa-user"></i> &nbsp;个人信息</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb" id="nav_title" style="position:static;float:none;">
        	<li class="active"><a href="index.jsp"><i class="fa fa-home" style="font-size:20px;position:relative;top:2px;left:-3px;"></i> &nbsp; 首页</a></li>      
    ...
    <section class="content" style="background:#fff;">
      <iframe id="myframe" scrolling="yes" frameborder="0" style="width:100%;min-height:200px;overflow:visible;background:#fff;" :src="main"></iframe>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
  ...
  <footer class="main-footer">
    ...
    Copyright &copy; 2017 <a href="" target="_blank">智能招生信息管理系统</a> All Rights Reserved
  </footer>
